...
Security fixes are applied to the current `main` branch and the current 1.7.x release line. Official Safire 1.7.x Windows, macOS, and Linux downloads are published only through this repository's GitHub Releases page.
