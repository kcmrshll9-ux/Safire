...
const SENSITIVE_TEXT_PATTERNS = Object.freeze([
  ...
  /(?<![A-Za-z0-9_])npm_[A-Za-z0-9]{36}(?![A-Za-z0-9_])/,
  /(?<![A-Za-z0-9_-])glpat-[A-Za-z0-9_-]{27,300}\.[a-z0-9]{9}(?![A-Za-z0-9_-]|\.[A-Za-z0-9])/,
  /(?<![A-Za-z0-9_-])glpat-[A-Za-z0-9_-]{20}(?![A-Za-z0-9_-]|\.[A-Za-z0-9])/,
  /(?<![A-Za-z0-9_-])AIza[A-Za-z0-9_-]{35}(?![A-Za-z0-9_-])/,
  /(?<![A-Za-z0-9_])(?:sk|rk)_(?:test|live)_[A-Za-z0-9]{20,247}(?![A-Za-z0-9_])/,
  /(?<![A-Za-z0-9_])hf_[A-Za-z0-9]{34}(?![A-Za-z0-9_])/,
